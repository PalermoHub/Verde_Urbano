...
async function inviaScheda(){
  ...
  const payload={
    ...
    quartiere:getProp(p,['Quartiere','quartiere','QUARTIERE']),
    upl:getProp(p,['UPL','upl','Upl']),
    altezza_complessiva:getProp(p,['Altezza complessiva [m]','Altezza complessiva','altezza_complessiva']),
    altezza_base_chioma:getProp(p,['Altezza della base della chioma [m]','Altezza della base della chioma','altezza_base_chioma']),
